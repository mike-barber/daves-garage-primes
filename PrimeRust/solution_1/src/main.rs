use flag_storage::FlagStorage;
use primes::{
    print_results_stderr, report_results_stdout, FlagStorageBitVector,
        ...
        fn reset_flags(&mut self, skip: usize) {
            if HYBRID {
                match skip {
                    ...
                    13 => BlockResetter::<BLOCK_SIZE, 13>::reset_flags_dense(&mut self.blocks),
                    15 => BlockResetter::<BLOCK_SIZE, 15>::reset_flags_dense(&mut self.blocks),
